...
alias lay4 = (zellij action new-tab -l .config/zellij/lay4)
alias lay1 = (zellij action new-tab -l .config/zellij/lay1)

# generates all the indices of a matrix or loop
def "get idxs" [nr: int, nc: int] { 
  0..($nr * $nc - 1) | each {|x|
    {
      row_idx: ($x //  $nc)
      col_idx: ($x mod $nc)
